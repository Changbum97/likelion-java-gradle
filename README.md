# 멋쟁이 사자처럼 JAVA (2022/10/04 ~ 2022/12/14)
...
## Day 28 (11/15 화)
- 알고리즘 - 퀵 정렬
  - pivot 보다 큰 수, 작은 수 그룹으로 나누고 나중에 합침
  - 재귀 사용

## Day 29 (11/16 수)
- 알고리즘 - 퀵 정렬
  - 배열 하나만 사용해서 공간 복잡도 절약
...
- 괄호 풀기 : p3129, p4624
- 탐색 : p3001, p2083
- 재귀 : p1851, p1853, p1854, p1855, p1856, p1859, p1860, p1904, p1912, p1925
- LCA : p1936
- LCS : p2699

## Programmers (해결한 문제)
- 코딩테스트 입문 : 자릿수 더하기
- 연습 문제 : 두 정수 사이의 합, 수박수박수박수박수박수?, 하샤드 수, 나누어 떨어지는 숫자 배열, 시저 암호, 행렬의 덧셈, 행렬의 곱셈, 명예의 전당, 기사단원의 무기
- 스택 : 올바른 괄호
- 정렬 : K번째수
- 해시 : 완주하지 못한 선수, 폰켓몬, 전화번호 목록
- 그리디 : 모의고사
- 소수 : 소수 찾기
- 스택/큐 : 같은 숫자는 싫어, 기능 개발
- 이진수 관련 : \[1차] 비밀지도, 이진 변환 반복하기
- 힙 : 더 맵게, 
